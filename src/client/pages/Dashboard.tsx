    ...
    <div className="space-y-8">
      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <div className="space-y-1">
          <h1 className="text-2xl font-semibold tracking-tight text-fg">HushPod</h1>
      ...
      <section className="space-y-4">
        <h2 className="text-sm font-semibold uppercase tracking-wide text-muted">Shows</h2>
        ...
        {isLoading ? (
          ...
          <div className="flex flex-col items-center justify-center gap-3 rounded-lg border border-danger/30 bg-danger/5 py-16 text-center">
            ...
            <div className="space-y-1">
              <p className="text-sm font-medium text-fg">Couldn’t load your shows</p>
          ...
          <div className="flex flex-col items-center justify-center gap-4 rounded-lg border border-dashed border-border bg-surface/40 py-16 text-center">
            ...
            <div className="space-y-1">
              ...
              <p className="mx-auto max-w-sm text-sm text-muted">
                Add a podcast RSS feed and HushPod will start stripping the ads from new episodes
                automatically.
              </p>
            </div>
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {showList.map((show) => (
              <ShowCard key={show.id} show={show} processing={anyProcessing && show.isActive} />
            ))}
          </div>
        )}
      </section>
